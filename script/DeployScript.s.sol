...
contract DeployScript is Script {
    function run() external {
        ...
        AZT azt = new AZT(10000 * 1e18, address(gov), "AZT", "AZT");
        ...
        // 3.final, should set reward start time (lastDistributionTime) and reward speed (tokensPerInterval) on distributor if determine the start time
